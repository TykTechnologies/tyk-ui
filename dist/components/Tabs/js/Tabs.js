...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/components/Tabs/js/Tabs.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!****************************************!*\
  !*** ./src/components/Tabs/js/Tabs.js ***!
  \****************************************/
/*! exports provided: TabsContext, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _Collapsible__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../Collapsible */ "./src/components/Collapsible/index.js");
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../Icon */ "./src/components/Icon/index.js");
/* harmony import */ var _sass_Tabs_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../sass/Tabs.scss */ "./src/components/Tabs/sass/Tabs.scss");
/* harmony import */ var _sass_Tabs_scss__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_sass_Tabs_scss__WEBPACK_IMPORTED_MODULE_11__);
...
var TabsContext = Object(react__WEBPACK_IMPORTED_MODULE_7__["createContext"])();

var Tabs =
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Tabs, _Component);
  ...
  function Tabs() {
    ...
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, (_getPrototypeOf2 = _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(Tabs)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Tabs, [{
    key: "updateTabsList",
    value: function updateTabsList(object, path, tabData) {
    ...
    value: function tabExists(path) {
      ...
      var key = tempPath.shift();
      return tempState.tabs && tempState.tabs[key] ? true : false;
    }
  }, {
    key: "addTab",
    value: function addTab(tabData, path) {
      var _this2 = this;

      this.setState(function (prevState) {
        var tempState = prevState;

        _this2.updateTabsList(tempState, path, tabData);
    ...
    key: "getTabCssClass",
    value: function getTabCssClass(id) {
    ...
    key: "genTabs",
    value: function genTabs(tabs, path) {
      var _this3 = this;

      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("ul", null, Object.keys(tabs).map(function (tabId) {
        var tempPath = path ? path.concat([tabs[tabId].id]) : [tabs[tabId].id];
        var iconType = tabs[tabId].collapsed ? 'chevron-up' : 'chevron-down';
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("li", {
          className: _this3.getTabCssClass(tabs[tabId].id),
          key: tabs[tabId].id
        }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
          onClick: _this3.setSelectedPath.bind(_this3, tempPath, tabs[tabId])
        }, tabs[tabId].title, tabs[tabId].collapsible ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_Icon__WEBPACK_IMPORTED_MODULE_10__["Icon"], {
          className: "collapsable-arrow",
          type: iconType
        }) : null), tabs[tabId].collapsible ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_Collapsible__WEBPACK_IMPORTED_MODULE_9__["Collapsible"], {
          collapsed: tabs[tabId].collapsed
        }, tabs[tabId].tabs ? _this3.genTabs(tabs[tabId].tabs, tempPath) : null) : tabs[tabId].tabs ? _this3.genTabs(tabs[tabId].tabs, tempPath) : null);
      }));
    }
  }, {
    key: "toggleTab",
    value: function toggleTab(tempState, path) {
      var tempPath = path.slice(0);
    ...
    key: "setSelectedPath",
    value: function setSelectedPath(path, tabData) {
      var _this4 = this;
      ...
      if (tabData.collapsible) {
        ...
        this.setState(function (prevState) {
          ...
          _this4.toggleTab(tempState, path);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        className: this.getCssClasses()
      }, this.genTabs(tabs), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(TabsContext.Provider, {
        value: {
          id: id,
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(Tabs, "propTypes", {
...
/***/ "./src/components/Tabs/sass/Tabs.scss":
/*!********************************************!*\
  !*** ./src/components/Tabs/sass/Tabs.scss ***!
  \********************************************/
/*! no static exports found */
