...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/components/Dropdown/js/DropdownItem.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/components/Dropdown/js/Dropdown.js":
/*!************************************************!*\
  !*** ./src/components/Dropdown/js/Dropdown.js ***!
  \************************************************/
/*! exports provided: default, DropdownContext */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _sass_Dropdown_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../sass/Dropdown.scss */ "./src/components/Dropdown/sass/Dropdown.scss");
/* harmony import */ var _sass_Dropdown_scss__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_sass_Dropdown_scss__WEBPACK_IMPORTED_MODULE_11__);
...
var DropdownContext = Object(react__WEBPACK_IMPORTED_MODULE_7__["createContext"])();

var Dropdown =
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Dropdown, _Component);
  ...
  function Dropdown(props) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this)), "state", {
      opened: false,
      selectedItem: _this.props.selectedItem || null
    });

    _this.dropdownRef = Object(react__WEBPACK_IMPORTED_MODULE_7__["createRef"])();
    _this.dropdownListRef = Object(react__WEBPACK_IMPORTED_MODULE_7__["createRef"])();
    _this.onSelectItem = _this.onSelectItem.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this)));
    _this.openDropdown = _this.openDropdown.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this)));
    _this.handleClickOutside = _this.handleClickOutside.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this)));
    return _this;
  }
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Dropdown, [{
    ...
    value: function handleClickOutside() {
      if (this.dropdownListRef.current && !this.dropdownListRef.current.contains(event.target) && this.dropdownRef.current && !this.dropdownRef.current.contains(event.target)) {
        this.closeDropdown();
      }
    }
  }, {
    ...
    key: "onSelectItem",
    value: function onSelectItem(itemId, itemProps) {
      var _this$props = this.props,
          stopButtonTextChange = _this$props.stopButtonTextChange,
    ...
    key: "isElemInBottomView",
    value: function isElemInBottomView(el, dropdownHeight) {
      var windowHeight = window.innerHeight;
      var offset = el.getBoundingClientRect();
      var elHeight = el.clientHeight;
      var elemBottom = offset.top + elHeight + dropdownHeight;
      return elemBottom <= windowHeight;
    }
  }, {
    key: "isElemInRightView",
    value: function isElemInRightView(el, dropdownWidth) {
      var windowWidth = window.innerWidth;
      var offset = el.getBoundingClientRect();
      var elemRight = offset.left + dropdownWidth;
    ...
    value: function getStyles() {
      ...
      var el = this.dropdownRef.current;
      var elHeight = el.clientHeight;
      var dropdownEl = this.dropdownListRef.current;
      var dropdownHeight = dropdownEl ? dropdownEl.clientHeight : 0;
      var dropdownWidth = dropdownEl ? dropdownEl.clientWidth : 0;
      var offset = el.getBoundingClientRect();
      var left = offset.left;
      var top = 0; //calculate top position, depending on the element position on the page
    ...
    key: "getWrapperCssClasses",
    value: function getWrapperCssClasses() {
      var _this$props2 = this.props,
          btnGroup = _this$props2.btnGroup,
          btnGroupSize = _this$props2.btnGroupSize;
      var cssClasses = ['tyk-dropdown'];
    ...
    key: "getCssClasses",
    value: function getCssClasses() {
      var cssClasses = ['tyk-dropdown-menu', 'tyk-dropdown'];
    ...
    value: function getBtnTitle() {
      var _this$props3 = this.props,
          btnTitle = _this$props3.btnTitle,
          stopButtonTextChange = _this$props3.stopButtonTextChange;
      var selectedItemProps = this.state.selectedItemProps;
    ...
    value: function render() {
      var _this$props4 = this.props,
          btnClassName = _this$props4.btnClassName,
          btnSize = _this$props4.btnSize,
          btnTitle = _this$props4.btnTitle,
          hasCustomContent = _this$props4.hasCustomContent,
          btnTheme = _this$props4.btnTheme,
          label = _this$props4.label,
          onSelect = _this$props4.onSelect;
      var DropdownWrapperTag = hasCustomContent ? 'div' : 'ul';
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
      ...
      }, " ", label) : null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_Button__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        ...
        size: btnSize || 'md',
        type: "button"
      }, this.getBtnTitle()), react_dom__WEBPACK_IMPORTED_MODULE_8___default.a.createPortal(react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(DropdownContext.Provider, {
        value: {
          onSelectItem: this.onSelectItem,
          selectedItem: this.state.selectedItem
        }
      }, this.state.opened ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(DropdownWrapperTag, {
        className: this.getCssClasses(),
        ref: this.dropdownListRef
      }, this.props.children) : null), document.querySelector('body')));
    }
  }]);
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(Dropdown, "propTypes", {
  children: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.element, prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.node, prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.string]),
  btnClassName: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.string,
  btnSize: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.string,
  btnTheme: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.string,
  btnTitle: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.string,
  btnGroup: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.bool,
  ...
  selectedItem: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.string,
  stopButtonTextChange: prop_types__WEBPACK_IMPORTED_MODULE_9___default.a.bool
});
...
/***/ "./src/components/Dropdown/js/DropdownItem.js":
/*!****************************************************!*\
  !*** ./src/components/Dropdown/js/DropdownItem.js ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Dropdown__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Dropdown */ "./src/components/Dropdown/js/Dropdown.js");
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../Icon */ "./src/components/Icon/index.js");
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(DropdownItem, _Component);
  ...
  function DropdownItem(props) {
    ...
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(DropdownItem).call(this, props));
    _this.dropdownItemCLick = _this.dropdownItemCLick.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this)));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(DropdownItem, [{
    key: "dropdownItemCLick",
    value: function dropdownItemCLick(dropdownContext, itemProps) {
      var _this$props = this.props,
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_Dropdown__WEBPACK_IMPORTED_MODULE_9__["DropdownContext"].Consumer, null, function (dropdownContext) {
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("li", {
          onClick: _this2.dropdownItemCLick.bind(_this2, dropdownContext, _this2.props)
        }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
          href: href
        }, eventKey && dropdownContext.selectedItem === eventKey ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_Icon__WEBPACK_IMPORTED_MODULE_10__["Icon"], {
          type: "check"
        }) : null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("span", null, title ? title : _this2.props.children)));
      });
    }
  }]);
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(DropdownItem, "propTypes", {
  children: prop_types__WEBPACK_IMPORTED_MODULE_8___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_8___default.a.element, prop_types__WEBPACK_IMPORTED_MODULE_8___default.a.node, prop_types__WEBPACK_IMPORTED_MODULE_8___default.a.string]),
  eventKey: prop_types__WEBPACK_IMPORTED_MODULE_8___default.a.string,
...
/***/ "./src/components/Dropdown/sass/Dropdown.scss":
/*!****************************************************!*\
  !*** ./src/components/Dropdown/sass/Dropdown.scss ***!
  \****************************************************/
/*! no static exports found */
