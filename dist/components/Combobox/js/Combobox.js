...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/components/Combobox/js/Combobox.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/components/Combobox/js/Combobox.js":
/*!************************************************!*\
  !*** ./src/components/Combobox/js/Combobox.js ***!
  \************************************************/
...
/* harmony import */ var _sass_Combobox_scss__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../sass/Combobox.scss */ "./src/components/Combobox/sass/Combobox.scss");
/* harmony import */ var _sass_Combobox_scss__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_sass_Combobox_scss__WEBPACK_IMPORTED_MODULE_12__);
...
var getStateSelectedValues = function getStateSelectedValues(multiple, tags, value) {
  if (!value) {
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(Combobox, _Component);

  function Combobox(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Combobox);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4___default()(Combobox).call(this, props));
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)), "state", {
      ...
      stateSelectedValues: getStateSelectedValues(_this.props.multiple, _this.props.tags, _this.props.value),
      searchText: ''
    });

    _this.comboboxRef = Object(react__WEBPACK_IMPORTED_MODULE_8__["createRef"])();
    _this.valuesListRef = Object(react__WEBPACK_IMPORTED_MODULE_8__["createRef"])();
    _this.inputRef = Object(react__WEBPACK_IMPORTED_MODULE_8__["createRef"])();
    _this.textRef = Object(react__WEBPACK_IMPORTED_MODULE_8__["createRef"])();
    _this.focusInput = _this.focusInput.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.onKeyUp = _this.onKeyUp.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.openList = _this.openList.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.handleClickOutside = _this.handleClickOutside.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.handleItemsNavigation = _this.handleItemsNavigation.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.handleComboboxDropdownClick = _this.handleComboboxDropdownClick.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.handleListItemClick = _this.handleListItemClick.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.handlePillRemoveClick = _this.handlePillRemoveClick.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    _this.manageSelectedTags = _this.manageSelectedTags.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this)));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Combobox, [{
    ...
    value: function onKeyUp(e) {
      ...
      var filteredValues = this.filterValues();
      var tempState = Object.assign({}, this.getSearchText());
      ...
      if (e.key === 'Enter') {
        var methodName = tags ? 'manageSelectedTags' : 'manageSelectedValues';
      ...
      if (!opened && this.inputRef.current.value && filteredValues && filteredValues.length && e.key !== 'Escape') {
    ...
    key: "handleItemsNavigation",
    value: function handleItemsNavigation(e) {
      var tags = this.props.tags;
      ...
      this.setState(function (previousState) {
        return _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, previousState, {
          opened: true,
          cursor: cursorNext
        });
      });
    ...
    value: function handleListItemClick(index) {
      var tags = this.props.tags;
      var methodName = tags ? 'manageSelectedTags' : 'manageSelectedValues';
      var tempState = Object.assign({}, tempState, this[methodName](index));
      this.setState(function (previousState) {
        return Object.assign({}, previousState, tempState);
      });
    }
  }, {
    key: "handlePillRemoveClick",
    value: function handlePillRemoveClick(index) {
      ...
      var tempState = this.removeSelectedValue(index);
      this.setState(function (previousState) {
        return Object.assign({}, previousState, tempState);
      });
    }
    ...
    value: function handleClickOutside() {
      ...
      if (this.valuesListRef.current && !this.valuesListRef.current.contains(event.target) && this.comboboxRef.current && !this.comboboxRef.current.contains(event.target)) {
        this.setState(function (previousState) {
          return Object.assign({}, previousState, _this2.closeList());
        });
      }
    }
  }, {
    key: "handleComboboxDropdownClick",
    value: function handleComboboxDropdownClick() {
      var _this3 = this;
      ...
      this.setState(function (previousState) {
        return Object.assign({}, previousState, _this3.openList());
      });
    }
  }, {
    key: "bindEvents",
    ...
    value: function filterValues() {
      ...
      var arr = values.filter(function (value) {
        return value.name.toLowerCase().indexOf(_this4.inputRef.current.value.toLowerCase()) > -1;
      });
      return arr;
    }
  }, {
    ...
    key: "isInInitialValues",
    value: function isInInitialValues(value) {
      var values = this.props.values;
      var ok = false;
    ...
    value: function getSelectedIndex(value) {
      var stateSelectedValues = this.state.stateSelectedValues;
      ...
      if (Array.isArray(stateSelectedValues)) {
        stateSelectedValues.forEach(function (item, index) {
          if (item.id === value.id) {
            position = index;
          }
        });
    ...
    value: function removeSelectedValue(index) {
      var stateSelectedValues = this.state.stateSelectedValues;
      var _this$props3 = this.props,
          onChange = _this$props3.onChange,
          values = _this$props3.values,
          input = _this$props3.input;
      var tempStateSelectedValues = JSON.parse(JSON.stringify(stateSelectedValues));
    ...
    key: "addSelectedValue",
    value: function addSelectedValue(value) {
      var stateSelectedValues = this.state.stateSelectedValues;
    ...
    key: "manageSelectedTags",
    value: function manageSelectedTags(index) {
      var stateSelectedValues = this.state.stateSelectedValues;
      var filteredValues = this.filterValues();
      ...
      var value = {
        id: this.inputRef.current.value,
        name: this.inputRef.current.value
      };
      var tempValue = filteredValues[index] || value;
      var selectedIndex = this.getSelectedIndex(tempValue);
      var selectedValues = {};
    ...
    key: "manageSelectedValues",
    value: function manageSelectedValues(index) {
      ...
      var stateSelectedValues = this.state.stateSelectedValues;
      var filteredValues = this.filterValues();
      var tempSelectedValues = filteredValues[index];
      var selectedValues;
      var selectedIndex = this.getSelectedIndex(tempSelectedValues);
      ...
      if (tempSelectedValues && multiple) {
        ...
        selectedValues = {
          stateSelectedValues: selectedIndex === -1 ? tempSelectedValues : {
            id: null
          }
        };
    ...
    key: "getListItemCssClasses",
    value: function getListItemCssClasses(value, index) {
      var cssClasses = [];
    ...
    key: "getComboboxListCssClass",
    value: function getComboboxListCssClass() {
      var opened = this.state.opened;
      var tags = this.props.tags;
      var cssClasses = ['tyk-combobox__list'];
    ...
    value: function getCssClasses() {
      ...
      var cssClasses = ['tyk-form-group', 'tyk-combobox'];
    ...
    key: "getInputError",
    value: function getInputError() {
      var error = this.props.error;
      return error && error !== 'true' && error !== 'false' ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("p", {
    ...
    value: function getStyles() {
      ...
      var el = this.comboboxRef.current;
      var elHeight = el.clientHeight;
      var elWidth = el.offsetWidth;
      var valuesListEl = this.valuesListRef.current;
    ...
    key: "getComboboxDisplayData",
    value: function getComboboxDisplayData() {
      var stateSelectedValues = this.state.stateSelectedValues;
      ...
      if (Array.isArray(stateSelectedValues) && multiple) {
        return stateSelectedValues.reduce(function (prevValue, value, index) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
      ...
      }, this.props.label ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("label", {
        htmlFor: this.props.id
      }, this.props.label) : null, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("ul", {
        className: "tyk-form-control",
        onClick: this.focusInput,
        ref: this.comboboxRef
      }, tags ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, stateSelectedValues.map(function (value, index) {
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("li", {
          className: "pill",
          key: value.id
        }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("a", {
          onClick: _this5.handlePillRemoveClick.bind(_this5, index)
        }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_Icon__WEBPACK_IMPORTED_MODULE_11__["Icon"], {
          type: "times"
        })), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("span", null, value.name));
      ...
      }, searchText))) : react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("li", {
        className: "tyk-combobox__placeholder",
        onClick: this.handleComboboxDropdownClick
      }, this.getComboboxDisplayData(), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_Icon__WEBPACK_IMPORTED_MODULE_11__["Icon"], {
        type: "arrow-down"
      }))), this.props.note ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("p", {
        className: "tyk-form-control__help-block"
      }, this.props.note) : null), this.getInputError(), opened && filteredValues.length ? react_dom__WEBPACK_IMPORTED_MODULE_9___default.a.createPortal(react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("ul", {
        className: this.getComboboxListCssClass(),
        ref: this.valuesListRef,
        style: this.getStyles()
      }, !tags ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("li", {
        className: "combobox-search__container"
      }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("input", {
        autoFocus: opened,
        className: "tyk-form-control",
        onKeyUp: this.onKeyUp,
        ...
        key: "searchInput",
        ref: this.inputRef
      })) : null, filteredValues.map(function (value, index) {
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("li", {
          className: _this5.getListItemCssClasses(value, index),
          onClick: _this5.handleListItemClick.bind(_this5, index),
          key: value.id
        }, _this5.getSelectedIndex(value) > -1 ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_Icon__WEBPACK_IMPORTED_MODULE_11__["Icon"], {
          type: "check"
        }) : null, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("span", null, " ", value.name));
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(Combobox, "propTypes", {
  ...
  tags: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.bool,
  validationmessages: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.object,
  values: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.array
});
...
/***/ "./src/components/Combobox/sass/Combobox.scss":
/*!****************************************************!*\
  !*** ./src/components/Combobox/sass/Combobox.scss ***!
  \****************************************************/
/*! no static exports found */
